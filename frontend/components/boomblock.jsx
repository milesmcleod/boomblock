...
class BoomBlock extends React.Component {
  ...
  animator() {
    ...
    // function createBlock () {
      const baseGeometry = new THREE.BoxGeometry(480, 360, 100); //width, height, depth
      ...
      const reelGeometry = new THREE.CylinderGeometry(60, 60, 10, 32);
      ...
      reelLeft.position.z = 55;
      reelLeft.rotation.x = Math.PI/2;

      const reelRight = new THREE.Mesh(reelGeometry, reelMaterial);
      reelRight.position.x = 10;
      reelRight.position.y = 200;
      reelRight.position.z = 55;
